...
class TestIntegrationFlows:
    ...
    def test_complete_billing_flow(self, mock_detect, mock_db_post, mock_db_get, sample_image_with_food):
        ...
        # Mock menu items BEFORE calling /detect
        mock_db_get.return_value = [
            {"name": "Burger",   "price": 150.0, "status": "active"},
            {"name": "Pizza",    "price": 200.0, "status": "active"},
            {"name": "Sandwich", "price": 100.0, "status": "active"},
        ]
        ...
        assert len(detected_items) > 0  # ✅ Now passes
